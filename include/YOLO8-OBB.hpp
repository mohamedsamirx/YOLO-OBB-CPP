...
// ===================================
//
// This header defines the YOLOv8-OBB-Detector class for performing object detection using the YOLOv8-OBB model.
...
/**
 * @file YOLOv8-OBB-Detector.hpp
 * @brief Header file for the YOLOv8OBBDetector class, responsible for object detection
...
/**
 * @namespace utils
 * @brief Namespace containing utility functions for the YOLOv8OBBDetector.
 */
namespace utils {
